...
const people = [
  {
    name: 'Roxana Núñez Trabucco',
    title: 'Author',
    image: imgRoxana,
    text: [
      'Roxana is a Peruvian author and teacher that holds a Masters Degree in Applied Linguistics to Teach Spanish as a Foreign Language, from the University of Jaén (Spain). Throughout her more than 16 years of experience as an elementary school Spanish teacher in California, and before beginning her career as an author, Roxana developed material considering her students suggestions and the specific conditions where she had to teach Spanish, as an after school activity.',
  ...
  {
    name: 'Robert Alminana',
    title: 'Editor',
    image: imgRobert,
    text: [
      'Robert Alminana is an educator living in San Francisco. He grew up in a multi-lingual, multi-national family and has lived in 9 different countries. He speaks five languages, is passionate about migration stories and loves to travel the world.',
    ],
  },
];
